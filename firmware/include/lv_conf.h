...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
     ...
     *Pool lives in PSRAM (see LV_MEM_POOL_ALLOC below); the GIF decoder needs
     *~38KB per frame plus all UI objects, so 64KB was too small (gif -> 0x0).*/
    #define LV_MEM_SIZE (2 * 1024 * 1024U)    /*[bytes] — 2MB in PSRAM*/
    ...
    #if LV_MEM_ADR == 0
        /* Allocate LVGL's pool from PSRAM (8MB) instead of internal RAM, so the
           ~64KB internal heap stays free for the Wi-Fi + BLE stacks. */
